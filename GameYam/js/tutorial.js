...
const STEPS = [
    ...
    { id: 'intro3', type: 'story', text: ['Two species crash-landed on opposite sides of a cluster of flat planets.'], duration: 3500 },
    { id: 'intro4', type: 'story', text: ['Between them lies a shared center earth. Build defenses there to survive!'], duration: 3500 },
    ...
    { id: 'toss', type: 'action', text: ['Press Q (P1) or . (P2) to toss materials toward the hub earth!'], hint: 'Press Q or . with an item', check: (g) => g.p1Tossed },
    ...
    { id: 'feed', type: 'story', text: ['Press R (P1) or O (P2) to toss Fiber (blue) or Coal (red) directly to your Feeder from anywhere!'], duration: 5000 },
